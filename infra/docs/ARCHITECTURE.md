...
After changing either Mermaid source, regenerate presentation exports with a local Mermaid CLI installation:

```powershell
npx.cmd @mermaid-js/mermaid-cli -i architecture/system-overview.mmd -o architecture/system-overview.svg -b white -w 2400
```
